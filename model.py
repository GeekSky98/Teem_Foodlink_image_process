...
def build_googlenet(img_size, n_class, regul, init):
    ...
    x_2 = Conv2D(filters=64, kernel_size=(1, 1), strides=1, activation='relu', padding="valid",
                 kernel_initializer=init, kernel_regularizer=regul)(x_1)
    x_2 = Conv2D(filters=192, kernel_size=(3, 3), strides=1, activation='relu', padding="same",
                 kernel_initializer=init, kernel_regularizer=regul)(x_2)
    ...
    aux_1 = Conv2D(filters=128, kernel_size=(1, 1), strides=1, padding='same', activation='relu',
                   kernel_initializer=init, kernel_regularizer=regul)(aux_1)
    aux_1 = Flatten()(aux_1)
    aux_1 = Dense(units=1024, activation='relu', kernel_initializer=init, kernel_regularizer=regul)(aux_1)
    aux_1 = Dropout(rate=0.7)(aux_1)
    aux_1 = Dense(units=n_class, activation='relu', kernel_initializer=init, kernel_regularizer=regul)(aux_1)
    ...
    aux_2 = Conv2D(filters=128, kernel_size=(1, 1), strides=1, padding='same', activation='relu',
                   kernel_initializer=init, kernel_regularizer=regul)(aux_2)
    aux_2 = Flatten()(aux_2)
    aux_2 = Dense(units=1024, activation='relu', kernel_initializer=init, kernel_regularizer=regul)(aux_2)
    aux_2 = Dropout(rate=0.7)(aux_2)
    aux_2 = Dense(units=n_class, activation='relu', kernel_initializer=init, kernel_regularizer=regul)(aux_2)
    ...
    x_fc = Dense(units=n_class, kernel_initializer=init, kernel_regularizer=regul)(x_fc)

    output = Activation('sigmoid')(x_fc)
